...
def ascii_translator(number)
  number.chr if number.is_a?(Integer)
end
...
def common_sports(current_sports, favorite_sports)
  current_sports.intersection(favorite_sports) if current_sports & favorite_sports
end
...
def alphabetical_list(games = %w[Chess Scrabble Othello Chess])
  games.uniq.sort
end
